...
<div class="col-sm-6 mt-5  mx-3">
  ...
  if (isset($_REQUEST['checkid'])) {
    ...
    if (!empty($row) && isset($row['request_id'])) { ?>
      ...
      <div class="text-center">
        ...
        <a class='btn btn-success' href='CheckStatus.php' style='padding:8px 16px; font-size: 15px;  background-color: #28a745;color: #fff; text-decoration:none;margin-left:3rem;'>Close</a>
      </div>
  <?php } else {
